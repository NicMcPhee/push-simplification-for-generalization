...
started_generalized_lookup <- bind_rows(mutate(unsimplified_that_generalize, started_generalized = 'Unsimplified Program Generalized'),
                                        mutate(unsimplified_that_dont_generalize, started_generalized = "Unsimplified Program Didn't Generalized"))
